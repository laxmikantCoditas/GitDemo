describe("1.x - Ext.Element - traversal - more", function() {
    ...
    describe("1.x - getScrollParent", function() {
        describe("1.x - when no parent scroller", function() {
            it("should return null", function() {
                expect(child5.getScrollParent()).toBeNull();
            });
        });
        
        xdescribe("1.x - when parent is a scroller", function() {
