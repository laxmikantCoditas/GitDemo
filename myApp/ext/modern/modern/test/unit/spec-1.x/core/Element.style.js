describe("1.x - Ext.Element - style", function() {
    ...
    describe("1.x - addCls", function() {
        ...
        describe("1.x - when array", function() {
    ...
    describe("1.x - removeCls", function() {
        describe("1.x - when string", function() {
            beforeEach(function() {
                el.addCls('test');
            });
    ...
    describe("1.x - mask", function() {
        ...
        describe("1.x - when iPad", function() {
            beforeEach(function() {
                Ext.is.iPad = true;
            });
    ...
    describe("1.x - radioCls", function() {
    ...
    describe("1.x - toggleCls", function() {
        it("should add the class", function() {
            expect(el.hasCls('test')).toBeFalsy();
    ...
    describe("1.x - replaceCls", function() {
    ...
    describe("1.x - getStyle", function() {
    ...
    describe("1.x - setStyle", function() {
        describe("1.x - string", function() {
    ...
    describe("1.x - getHeight", function() {
    ...
    describe("1.x - getWidth", function() {
    ...
    describe("1.x - setWidth", function() {
        beforeEach(function() {
    ...
    describe("1.x - setHeight", function() {
        beforeEach(function() {
    ...
    describe("1.x - getBorderWidth", function() {
    ...
    describe("1.x - getPadding", function() {
        it("should call sumStyles with the side config", function() {
            var spy = spyOn(el, "sumStyles").andCallThrough();
    ...
    describe("1.x - getMargin", function() {
        it("should call sumStyles with the side config", function() {
            var spy = spyOn(el, "sumStyles").andCallThrough();
    ...
    describe("1.x - getViewSize", function() {
        describe("1.x - element", function() {
        ...
        describe("1.x - document/body", function() {
            it("should return the view sizes", function() {
    ...
    describe("1.x - getOuterWidth", function() {
    ...
    describe("1.x - getOuterHeight", function() {
    ...
    describe("1.x - sumStyles", function() {
        describe("1.x - 1 side", function() {
