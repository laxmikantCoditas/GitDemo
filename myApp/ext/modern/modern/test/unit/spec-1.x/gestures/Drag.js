Ext.require('Ext.gesture.Drag', function() {

describe("1.x - Ext.gesture.Drag", function() {
    var manager = Ext.gesture.Manager,
        gesture, spy, 
        listener = {fire: function() {}};
    
    describe("1.x - events", function() {    
        describe("1.x - dragstart", function() {
            beforeEach(function() {
