describe("1.x - Ext.gesture.Tap", function() {
    var manager = Ext.gesture.Manager,
        gesture, spy, 
        listener = {fire: function() {}};
    
    describe("1.x - events", function() {    
        describe("1.x - tapstart", function() {
            beforeEach(function() {
        ...
        describe("1.x - tapcancel", function() {
            beforeEach(function() {
                spy = spyOn(listener, 'fire');
        ...
        describe("1.x - doubletap", function() {
            beforeEach(function() {
                spy = spyOn(listener, 'fire');
        ...
        describe("1.x - singletap", function() {
            beforeEach(function() {
                spy = spyOn(listener, 'fire');
