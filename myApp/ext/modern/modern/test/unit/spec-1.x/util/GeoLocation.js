describe("1.x - Ext.util.GeoLocation", function() {
    var geo;
    beforeEach(function() {
    geo = new Ext.util.GeoLocation();
});
    if (Ext.supports.GeoLocation) {
        describe("1.x - if browser has geolocation support", function() {
            beforeEach(function() {
            ...
            describe("1.x - instantiation", function() {
                ...
                describe("1.x - configuration options", function() {
            ...
            describe("1.x - methods", function() {
                describe("1.x - setMaximumAge", function() {
                ...
                describe("1.x - setTimeout", function() {
                ...
                describe("1.x - setAllowHighAccuracy", function() {
                ...
                describe("1.x - setAutoUpdate", function() {
                    var watchOperation;
                ...
                describe("1.x - updateLocation", function() {
                    var fakeCallback;
                    ...
                    describe("1.x - when getCurrentPosition throw an error", function() {
                        beforeEach(function() {
                    ...
                    describe("1.x - when getCurrentPosition is successful", function() {
                        var fakePosition,
                            coords;

                        describe("1.x - and call the success callback", function() {
                            beforeEach(function() {
                                fakePosition = {
                        ...
                        describe("1.x - when heading and speed aren't defined", function() {
                            beforeEach(function() {
                                fakePosition = {
                                    timestamp: 1285837067410,
                                    coords: {
                    ...
                    describe("1.x - when getCurrentPosition failed", function() {
                        var fakeError;
                ...
                describe("1.x - getLocation", function() {
                    var fakeCallback,
                        updateLocationSpy;
        ...
        describe("1.x - if browser hasn't geoLocation support", function() {
            beforeEach(function() {
                spyOn(Ext.util.GeoLocation.prototype, "setAutoUpdate").andCallThrough();
                geo = new Ext.util.GeoLocation();
            });
