describe("1.x - Ext.util.Draggable", function() {
    ...
    describe("1.x - constructor", function() {
        ...
        describe("1.x - direction", function() {
            it("none", function() {
                draggable = createDraggable();
        ...
        describe("1.x - startEventName", function() {
            describe("1.x - when delay > 0", function() {
                it("taphold", function() {
                    draggable = createDraggable({
                        delay: 400
                    });
    ...
    describe("1.x - onStart", function() {
        ...
        describe("1.x - cancelSelector", function() {
            describe("1.x - when cancelSelector and found", function() {
            ...
            describe("1.x - when no cancelSelector and not found", function() {
    ...
    xdescribe("1.x - prepareDrag", function() {
        beforeEach(function() {
            e = {
                pageX: 0,
                pageY: 0
        ...
        describe("1.x - constrain", function() {
            describe("1.x - when window", function() {
