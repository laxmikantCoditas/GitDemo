Ext.require('Ext.form.FormPanel', function() {

describe("1.x - Ext.form.FormPanel", function() {
    ...
    describe("1.x - when rendered", function() {
        ...
        describe("1.x - on onSubmit", function() {
            beforeEach(function() {
                called = false;
        ...
        describe("1.x - on loadRecord", function() {
        ...
        describe("1.x - on loadModel", function() {
            it("should load a record", function() {
                var spy = spyOn(fp, "setValues").andCallThrough();
        ...
        describe("1.x - on getRecord", function() {
            describe("1.x - when no record", function() {
                it("should return nothing", function() {
                    expect(fp.getRecord()).not.toBeDefined();
                });
            });
            
            describe("1.x - when record", function() {
                beforeEach(function() {
                    fp.loadRecord(user);
                });
        ...
        describe("1.x - on setValues", function() {
            beforeEach(function() {
                fp.loadRecord(user);
            });
        ...
        describe("1.x - on getValues", function() {
            beforeEach(function() {
                fp.loadRecord(user);
            });
            ...
            describe("1.x - when a field is disabled", function() {
                beforeEach(function() {
        ...
        describe("1.x - on reset", function() {
            beforeEach(function() {
                fp.loadRecord(user);
            });
        ...
        describe("1.x - on getFields", function() {
            ...
            describe("1.x - when it has a fieldset", function() {
                it("should return 4 fields", function() {
        ...
        describe("1.x - on showMask", function() {
            it("should show the mask", function() {
                fp.showMask('message');
            });
        });
        
        describe("1.x - on hideMask", function() {
            beforeEach(function() {
                fp.showMask('message');
            });
