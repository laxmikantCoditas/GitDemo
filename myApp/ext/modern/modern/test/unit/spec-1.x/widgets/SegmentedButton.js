Ext.require('Ext.SegmentedButton', function() {

describe("1.x - Ext.SegmentedButton", function() {
    var sb;
    ...
    describe("1.x - when setPressed", function() {
        ...
        describe("1.x - when allowMultiple", function() {
            beforeEach(function() {
                sb.destroy();
                sb = new Ext.SegmentedButton({
                    allowMultiple: true,
