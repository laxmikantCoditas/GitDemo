Ext.require(['Ext.Sheet', 'Ext.ActionSheet'], function() {

describe("1.x - Ext.Sheet", function() {
    var sheet;
    ...
    describe("1.x - when orient", function() {
        ...
        describe("1.x - when there is a cfg.x || cfg.y", function() {
            beforeEach(function() {
        ...
        describe("1.x - when arrive = left", function() {
            beforeEach(function() {
                sheet.arrive = "left";
            });
    ...
    describe("1.x - when onShow", function() {
    ...
    describe("1.x - when onOrientationChange", function() {
        it("should call orient", function() {
            spyOn(sheet, "orient").andCallThrough();
...
describe("1.x - Ext.ActionSheet", function() {
    var sheet;
