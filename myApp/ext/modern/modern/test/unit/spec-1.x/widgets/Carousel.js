Ext.require(['Ext.carousel.Carousel', 'Ext.carousel.Indicator'], function() {

describe("1.x - Ext.Carousel", function() {
    ...
    describe("1.x - initComponent", function() {
        ...
        describe("1.x - when indicator", function() {
        ...
        describe("1.x - when no indicator", function() {
    ...
    describe("1.x - afterLayout", function() {
        beforeEach(function() {
            makeCarousel();
        });
    ...
    describe("1.x - getCardOffset", function() {
        beforeEach(function() {
            makeCarousel();
        });
    ...
    describe("1.x - getCardIndexOffset", function() {
        beforeEach(function() {
            makeCarousel();
        });
    ...
    describe("1.x - isCardInRange", function() {
        beforeEach(function() {
            makeCarousel();
        });
    ...
    describe("1.x - getActiveIndex", function() {
        beforeEach(function() {
            makeCarousel();
        });
    ...
    describe("1.x - scrollToCard", function() {
        beforeEach(function() {
            makeCarousel();
        });
        ...
        describe("1.x - horizontal", function() {
        ...
        describe("1.x - vertical", function() {
            beforeEach(function() {
                carousel.destroy();
                makeCarousel({
                    direction: 'vertical'
    ...
    describe("1.x - onTransitionEnd", function() {
        beforeEach(function() {
            makeCarousel();
        ...
        describe("1.x - when oldCard is current card", function() {
        ...
        describe("1.x - when oldCard is not current card", function() {
            beforeEach(function() {
    ...
    describe("1.x - onCardSwitch", function() {
        describe("1.x - horizontal", function() {
            beforeEach(function() {
                makeCarousel();
            });
    ...
    describe("1.x - Ext.Carousel.Indicator", function() {
        ...
        it("should have a baseCls", function() {
            expect(indicator.baseCls).toEqual('x-carousel-indicator');
        });
        ...
        describe("1.x - onRender", function() {
        ...
        describe("1.x - createIndicator", function() {
            beforeEach(function() {
                carousel.render(Ext.getBody());
            });
        ...
        describe("1.x - onBeforeCardSwitch", function() {
            beforeEach(function() {
                carousel.render(Ext.getBody());
            });
        ...
        describe("1.x - add/remove", function(){
            var withChildren;
            beforeEach(function(){
                carousel.render(Ext.getBody());
            ...
            describe("1.x - onCardAdd", function(){
            ...
            describe("1.x - onCardRemove", function(){
