Ext.require('Ext.tab.Bar', function() {

describe("1.x - Ext.tab.Bar", function() {
    ...
    describe("1.x - when rendered", function() {
        ...
        describe("1.x - when sortable", function() {
            beforeEach(function() {
                tb.destroy();
                tb = new Ext.tab.Bar({
                    sortable: true,
    ...
    // describe("1.x - when cardLayout", function() {
    //     beforeEach(function() {
    //         cards = new Ext.Panel({
    //             layout: 'card',
    //             
    ...
    describe("1.x - when onTabTap", function() {
...
describe("1.x - Ext.tab.Tab", function() {
    var tab;
    ...
    describe("1.x - on getCard", function() {
        it("should get the card", function() {
            expect(tab.getCard()).not.toBeDefined();
        });
    });
    
    describe("1.x - when activated", function() {
...
describe("1.x - Ext.tab.Panel", function() {
    var tp;
    
    beforeEach(function() {
        tp = new Ext.tab.Panel({
            fullscreen: true,
            ui        : 'dark',
            sortable  : true,
    ...
    describe("1.x - when tab.setCard", function() {
    ...
    describe("1.x - when tp.add", function() {
    ...
    describe("1.x - when tp.remove", function() {
    ...
    describe("1.x - when dockedItems", function() {
        beforeEach(function() {
            tp.destroy();
            tp = new Ext.tab.Panel({
                fullscreen: true,
    ...
    describe("1.x - when tb.onTabTap", function() {
