Ext.require('Ext.form.Spinner', function() {

describe("1.x - Ext.form.Spinner", function() {
    var field;
    ...
    describe("1.x - on render", function() {
        ...
        describe("1.x - when onSpinDown", function() {
            beforeEach(function() {
                field.render(Ext.getBody());
            });
        ...
        describe("1.x - when onSpinUp", function() {
            beforeEach(function() {
                field.render(Ext.getBody());
            });
        ...
        describe("1.x - when spin", function() {
            beforeEach(function() {
                field.render(Ext.getBody());
            });
        ...
        describe("1.x - when destroy", function() {
            beforeEach(function() {
                field.render(Ext.getBody());
            });
