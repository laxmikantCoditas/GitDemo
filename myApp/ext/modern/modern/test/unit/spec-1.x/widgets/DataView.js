Ext.require('Ext.DataView', function() {

describe("1.x - Ext.DataView", function() {
    ...
    describe("1.x - addCmpEvents", function() {
        describe("1.x - when forceSelection", function() {
    ...
    describe("1.x - event methods", function() {
        ...
        describe("1.x - onTap", function() {
            describe("1.x - when there is an item", function() {
            ...
            describe("1.x - when there is not an item", function() {
                beforeEach(function() {
                    isItem = false;
                });
        ...
        describe("1.x - onTapStart", function() {
            describe("1.x - when there is an item", function() {
                describe("1.x - when there is a pressedDelay", function() {
                ...
                describe("1.x - when there is no pressedDelay", function() {
                    beforeEach(function() {
                        dv.destroy();
                        panel.destroy();
        ...
        describe("1.x - onTapCancel", function() {
            describe("1.x - when there is a timeout", function() {
                beforeEach(function() {
            ...
            describe("1.x - when item", function() {
                beforeEach(function() {
                    el.addCls(dv.pressedCls);
                });
        ...
        describe("1.x - onDoubleTap", function() {
        ...
        describe("1.x - onItemTap", function() {
            describe("1.x - when pressedTimeout", function() {
                beforeEach(function() {
                    dv.pressedTimeout = setTimeout(function() {}, 1000);
                });
