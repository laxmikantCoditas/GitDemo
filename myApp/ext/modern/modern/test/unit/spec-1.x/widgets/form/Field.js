Ext.require('Ext.form.Field', function() {

describe("1.x - Ext.form.Field", function() {
    var field, panel;
    ...
    describe("1.x - on getName", function() {
...
//            expect(field.getValue()).toEqual('');
    ...
    describe("1.x - on render", function() {
        describe("1.x - when required", function() {
            beforeEach(function() {
                field.required = true;
        ...
        describe("1.x - when label", function() {
            beforeEach(function() {
                field.render(Ext.getBody());
            });
        ...
        describe("1.x - with all values", function() {
            beforeEach(function() {
...
//                field.showClear = true;
    ...
    describe("1.x - after render", function() {
        ...
        xdescribe("1.x - on onEnable", function() {
            beforeEach(function() {
                field.onDisable();
            });
        ...
        xdescribe("1.x - on onDisable", function() {
            it("should checkClear", function() {
        ...
        xdescribe("1.x - on isDirty", function() {
        ...
        xdescribe("1.x - on onClearTap", function() {
        ...
        xdescribe("1.x - on onKeyUp", function() {
        ...
        xdescribe("1.x - on onFocus", function() {
        ...
        xdescribe("1.x - on onBlur", function() {
        ...
        xdescribe("1.x - on focus", function() {
        ...
        xdescribe("1.x - on blur", function() {
