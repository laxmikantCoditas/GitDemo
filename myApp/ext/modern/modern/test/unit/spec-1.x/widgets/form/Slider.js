Ext.require('Ext.form.Slider', function() {

describe("1.x - Ext.form.Slider", function() {
    ...
    it("should have a ui", function() {
        expect(field.ui).toEqual('slider');
    });
    
    it("should have an inputCls", function() {
        expect(field.inputCls).toEqual('x-slider');
    });
    
    it("should have an inputType", function() {
        expect(field.inputType).toEqual('slider');
    });
    
    it("should have a minValue", function() {
        expect(field.minValue).toEqual(0);
    });
    
    it("should have a maxValue", function() {
        expect(field.maxValue).toEqual(100);
    });
    
    it("should animationDuration", function() {
        expect(field.animationDuration).toBeTruthy();
    });
    ...
    it("should have a trackWidth", function() {
        expect(field.trackWidth).toBeNull();
    });
    ...
    it("should have an increment", function() {
        expect(field.increment).toEqual(1);
    });
    
    describe("1.x - when value is set", function() {
        beforeEach(function() {
            field.destroy();
            field = new Ext.form.Slider({
                label: 'test',
    ...
    describe("1.x - when rendered", function() {
        ...
        describe("1.x - on constrain", function() {
            beforeEach(function() {
                field.increment = 10;
                field.maxValue = 78;
            });
        ...
        describe("1.x - on constrain with minValue != 0", function() {
            beforeEach(function() {
                field.increment = 20;
                field.maxValue = 200;
                field.minValue = -100;
        ...
        describe("1.x - on onThumbDragEnd", function() {
            it("should call getThumbValue", function() {
                var spy = spyOn(field, "getThumbValue").andCallThrough();
        ...
        describe("1.x - on onTap", function() {
        ...
        describe("1.x - setThumbsDisabled", function() {
            describe("1.x - disable", function() {
        ...
        xdescribe("1.x - disable", function() {
