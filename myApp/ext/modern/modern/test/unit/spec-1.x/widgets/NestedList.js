Ext.require(['Ext.NestedList', 'Ext.data.*', 'Ext.data.TreeStore'], function(){


describe("1.x - Ext.NestedList", function() {
    ...
    describe("1.x - getDetailCard", function() {
    ...
    describe("1.x - initComponent", function() {
        describe("1.x - when useToolbar", function() {
            ...
            describe("1.x - when no toolbar", function() {
                describe("1.x - toolbar", function() {
                    beforeEach(function() {
                        makeNestedList();
                    });
            ...
            describe("1.x - when toolbar", function() {
                var toolbar;
