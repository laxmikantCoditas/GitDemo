Ext.require('Ext.form.Checkbox', function() {

describe("1.x - Ext.form.Checkbox", function() {
    var cb, panel, fields;
    ...
    describe("1.x - not rendered", function(){
    ...
    describe("1.x - after render", function() {
        ...
        describe("1.x - on setChecked()", function() {
        ...
        describe("1.x - on check()", function() {
        ...
        describe("1.x - on uncheck()", function() {
    ...
    describe("1.x - when a group", function() {
        ...
        describe("1.x - on setGroupValues", function() {
        ...
        describe("1.x - on getGroupValues", function() {
