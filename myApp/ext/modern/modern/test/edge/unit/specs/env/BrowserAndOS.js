describe("Ext.env.Browser and Ext.env.OS", function() {
    ...
    var profiles = {
        ...
        "webOS 3.0 / HP TouchPad 1.0": {
            platform: '',
            userAgent: 'Mozilla/5.0 (hp-tablet; Linux; hpwOS/3.0.0; U; en-US) AppleWebKit/534.6 (KHTML, like Gecko) wOSBrowser/233.70 Safari/534.6 TouchPad/1.0',
            expect: {
                browser: {
                    name: 'webOSBrowser',
                    flags: ['WebKit', 'WebKit534', 'WebKit5346', 'webOSBrowser', 'webOSBrowser233', 'webOSBrowser23370'],
                    version: '233.70'
                },
                os: {
                    name: 'webOS',
                    flags: ['webOS', 'webOS3', 'webOS300'],
                    version: '3.0.0'
                }
            }
        },
        ...
        "HTC_Sensation_Z710e with OSX userAgent": {
            ...
            expect: {
                browser: {
                    name: 'Safari',
                    flags: ['Safari', 'Safari5', 'Safari50', 'WebKit', 'WebKit533', 'WebKit53316', 'safari', 'safari5', 'safari50', 'webkit', 'webkit533', 'webkit53316'],
                    version: '5.0'
                },
                os: {
                    name: 'Android',
        ...
        "Amazon Kindle Fire": {
            ...
            expect: {
                browser: {
                    name: 'Silk',
                    flags: [ 'Silk', 'Silk1', 'Silk10138110003810', 'WebKit', 'WebKit533', 'WebKit53316', 'silk', 'silk1', 'silk10138110003810', 'webkit', 'webkit533', 'webkit53316'],
