describe("Ext.Object", function(){
    ...
    describe("equals()", function() {
        it("should return true even if the order of keys is different", function() {
            expect(Ext.Object.equals({ foo: 1, bar: '2' }, { bar: '2', foo: 1 })).toBe(true);
        });

        it("should return true with array values", function() {
            expect(Ext.Object.equals({ foo: [1, 2, 3], bar: ['4', [ '5', '6']] }, { bar: ['4', [ '5', '6']], foo: [1, 2, 3] })).toBe(true);
        });

        it("should return true with nested objects", function() {
            expect(Ext.Object.equals({ foo: { bar: {baz: { boom: 1 }} }}, { foo: { bar: {baz: { boom: 1 }} }})).toBe(true);
        });

        it("should return false when a key's name is different", function() {
            expect(Ext.Object.equals({ foo: 1, bar: 2 }, { foo: 1, baz: 2 })).toBe(false);
        });

        it("should return false when a key exists in one but not the other", function() {
            expect(Ext.Object.equals({ foo: 1, bar: 2, baz: 3 }, { foo: 1, bar: 2 })).toBe(false);
        });
    });
