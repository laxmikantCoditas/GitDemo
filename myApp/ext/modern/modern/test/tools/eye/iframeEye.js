...
InnerEye.extend({
    ...
    execute: function(dir) {
        var runFiles  = this.scanDirectory(dir),
            examples  = [],
            allExamples = "",
            length    = runFiles.length,
        ...
        runFiles.forEach(function(example, i) {
        ...
        system.execute('/Applications/phantomjs.app/Contents/MacOS/phantomjs test/eye/massGrab.js ' + allExamples);
