...
function doTest() {
    ...
    var tstore1 = Ext.create('Ext.data.TreeStore', {
        proxy: {
            type: 'ajax',
            url: '../../examples/kitchensink/resources/data/tree/check-nodes.json'
        },
        sorters: [{
            property: 'leaf',
            direction: 'ASC'
    ...
    var tree4 = Ext.create('Ext.tree.Panel', {
        ...
        dockedItems: [{
            ...
            items: {
                text: 'Get checked nodes',
                handler: function () {
                    var records = tree4.getView().getChecked(),
                        names = [];
    ...
    var tree5 = Ext.create('Ext.tree.Panel', {
        ...
        dockedItems: [{
            ...
            items: {
                text: 'Get checked nodes',
                handler: function () {
                    var records = tree5.getView().getChecked(),
                        names = [];
    ...
    Ext.log("Total Load and layout Time ", end - now, ' just layout: ', end - ready);
}
