...
Ext.onReady(function () {
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            {
                xtype: 'actioncolumn',
                id: 'firstActionColumn',
                width: 20,
                items: [
                    {
                        icon: '../../examples/shared/icons/fam/information.png',
                        getClass: function (value, metadata, record) {
                            return 'x-display';
                        },
                        tooltip: 'Click here to see additional details for this transition.'
                    }
                ],
                listeners: {
                    click: function (view, cell, rowIndex, colIndex, e) {
                        alert(rowIndex);
                    }
                }
            },
