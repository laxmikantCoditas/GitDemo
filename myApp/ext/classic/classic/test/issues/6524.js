...
Ext.onReady(function() {
    ...
    Ext.getBody().setStyle('padding', '10px').createChild('<h1 style="font-size:20px;margin-bottom:10px">You should be able to type spaces and use left and right arrows in the input field in the expanded row</h1>');
    ...
    Ext.create('Ext.grid.Panel', {
        ...
        plugins: [{
            ptype: 'rowexpander',
            rowBodyTpl : [
                '<p><input/><b>Company:</b> {company}</p><br>',
