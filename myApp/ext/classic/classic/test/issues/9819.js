            ...
            items: [
                {
                    ...
                    text: 'Collapse All',
                    handler: function(){
                        if(grid.lockedGrid.getView().getFeature('group').isExpanded() === true){
                            this.setText('Expand All');
                            grid.lockedGrid.getView().getFeature('group').collapseAll();
                        }else{
                            this.setText('Collapse All');
                            grid.lockedGrid.getView().getFeature('group').expandAll();
                        }
                    }
                }
            ]
