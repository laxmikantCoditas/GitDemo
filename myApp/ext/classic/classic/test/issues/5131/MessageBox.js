...
Ext.define('Ext.window.MessageBox', {
    ...
    initComponent: function() {
        ...
        me.items = [me.topContainer, me.progressBar, me.bottomTb];
    ...
    resetLayoutState: function(cfg) {
        var me = this,
            width = cfg.width,
            flex = width ? 1 : undefined,
            stretch = width ? 'stretch' : 'stretchmax',
            comps = me.layoutComps,
            i, cmp, el, len;

        me.promptContainer.flex = flex;
        me.layout.align =
            me.promptContainer.layout.align = stretch;
